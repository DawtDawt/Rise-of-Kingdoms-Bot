...
class GuiDetector:
    ...
    def get_windows_name(self):
        path, size, box, threshold, least_diff, gui = (
            ImagePathAndProps.WINDOW_TITLE_MARK_IMG_PATH.value
        )
        ...
        title_image = img_remove_background_and_enhance_word(
            title_image, np.array([0, 0, 160]), np.array([255, 255, 255])
        )
